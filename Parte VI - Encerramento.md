...
- **Exploração × _exploitation_** — experimentar o desconhecido versus usar o melhor conhecido; equilíbrio via ε-greedy; dilema recorrente também no GA (mutação × crossover).
