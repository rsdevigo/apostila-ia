...
**Vantagens.** O A\* reúne um conjunto raro de qualidades que explicam seu domínio. É **ótimo** sob heurística admissível — devolve comprovadamente o caminho de menor custo. É **completo** — se existe um caminho, ele o encontra; se não existe, ele reporta a falha. É **geral** — funciona sobre *qualquer* grafo (grade, waypoints, NavMesh), pois nada em sua mecânica depende da representação, apenas de "nós, vizinhos e custos". É **eficiente** — entre os algoritmos que garantem otimalidade com uma dada heurística, o A\* é, num sentido preciso demonstrado na literatura, o que expande o menor número de nós. E é **sintonizável** — via a escolha e o peso da heurística, permite negociar otimalidade por velocidade conforme a necessidade do jogo.
